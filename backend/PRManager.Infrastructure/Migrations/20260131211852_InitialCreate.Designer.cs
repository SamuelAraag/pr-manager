...
namespace PRManager.Infrastructure.Migrations
{
    ...
    [Migration("20260131211852_InitialCreate")]
            ...
            modelBuilder.Entity("PRManager.Domain.Models.AutomationConfig", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2026, 1, 31, 21, 18, 51, 705, DateTimeKind.Utc).AddTicks(3000),
                            Description = "GitHub API token for repository operations",
                            IsEncrypted = true,
                            Key = "GitHub.Token",
                            UpdatedAt = new DateTime(2026, 1, 31, 21, 18, 51, 705, DateTimeKind.Utc).AddTicks(3000),
                            Value = ""
                        },
                        new
                        {
                        ...
                        {
                            Id = 4,
                            CreatedAt = new DateTime(2026, 1, 31, 21, 18, 51, 705, DateTimeKind.Utc).AddTicks(3010),
                            Description = "GitLab project ID for issue creation",
                            IsEncrypted = false,
                            Key = "GitLab.ProjectId",
                            UpdatedAt = new DateTime(2026, 1, 31, 21, 18, 51, 705, DateTimeKind.Utc).AddTicks(3010),
                            Value = ""
                        });
                });
            ...
            modelBuilder.Entity("PRManager.Domain.Models.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2026, 1, 31, 21, 18, 51, 705, DateTimeKind.Utc).AddTicks(1300),
